...
const ImovelCardFull = ({ id, cidade, bairro, valor, imageUrls, videoUrl, descricao, petsAllowed, furnished, garagem, quartos, banheiros }) => {
  ...
  return (
    <Card
      ...
      style={{ maxWidth: '300px', margin: '10px', borderRadius: '10px', overflow: 'hidden' }}
    >
      <div style={{ position: 'relative', width: '100%', paddingTop: '100%' }}>
        ...
        <div style={{
          ...
          <Typography variant="body1" style={{ color: '#000', fontWeight: 'bold', fontFamily: 'OpenSans-Italic, sans-serif' }}>
            {bairro} - {cidade}
          </Typography>
      ...
      <Modal open={isFormOpen} onClose={() => setIsFormOpen(false)}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: '#fff', padding: '20px', borderRadius: '8px', width: '90%', maxWidth: '400px' }}>
          <Typography variant="subtitle1" style={{ marginBottom: '20px', textAlign: 'center' }}>Entre em contato conosco também por aqui!</Typography>
