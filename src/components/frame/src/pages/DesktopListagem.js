...
const DesktopListagem = () => {
  return (
    <>
      <FrameComponent1 />
      <div className="w-full relative bg-white overflow-hidden flex flex-col items-center justify-start pt-10 pb-[937px] pr-[21px] pl-5 box-border gap-[20px] leading-[normal] tracking-[normal]">
